...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, ButtonComponent, NgForOf, NgIf],
  template: `
    ...
    <select
      [(ngModel)]="UserDataHandlerService.Selection"
      name="userss"
      id="userss"
    >
      <option
        *ngFor="let user of UserDataHandlerService.localLoggedUsers"
        [ngValue]="user"
      >
        {{ user.toString() }}
      </option>
    ...
    <div class="modeSelectorCont">
      <div class="mainCont">
        ...
        <div>
          ...
          <p>
            &nbsp;Name&nbsp;:&nbsp;<input type="text" [(ngModel)]="inputName" />
          </p>
        </div>
      </div>
      ...
      <div class="statsContainer">
        <ng-container *ngIf="UserDataHandlerService.Selection != undefined">
          <ng-container
            ...
            <ng-container
              *ngFor="
                let kvPair of UserDataHandlerService.Selection.getKVPairs()
              "
            >
              <div class="gridRow">
