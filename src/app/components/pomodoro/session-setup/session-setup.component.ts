...
@Component({
  ...
  template: `
    <div class="container">
    <h1>Session&nbsp;setup</h1>
    <p>Break Time&nbsp;:&nbsp;<input type="text" maxlength="2" [(ngModel)]="breakInputTime" [disabled]="locked"></p>
    <p>Work Time&nbsp;&nbsp;:&nbsp;<input type="text" maxlength="2" [(ngModel)]="workInputTime" [disabled]="locked"></p>
    <app-button (click)="setSession()" type="funcBtn" tmpLbl="Validate" [isDisabled]="locked"></app-button>
    </div>
  `,
  styles: `
`
