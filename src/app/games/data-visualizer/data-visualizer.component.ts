    ...
    <div class="contBg">
      ...
      <div class="container">
        ...
        <div class="buttonsContainerDV">
          <app-button type="funcBtn" tmpLbl="Change&nbsp;Mode" (click)="UseChildOptions()"
                      [isDisabled]="false"></app-button>
          ...
          <app-button type="funcBtn" (click)="useCurrentUser()" tmpLbl="Use Current User"
                      [isDisabled]="false"></app-button>
        </div>
